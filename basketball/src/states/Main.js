...
class Main extends Phaser.State {
    ...
    shoot(basketball) {
        ...
        let pointer = _this.game.input.activePointer;
        let x = pointer.x - _this.pointerStart.x;
        let y = pointer.y - _this.pointerStart.y;
        let duration = Math.round(pointer.duration);
        let length = Math.round(new Phaser.Line(_this.pointerStart.x, _this.pointerStart.y, pointer.x, pointer.y).length);
