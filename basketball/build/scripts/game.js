...
var Main = (function (_Phaser$State) {
  ...
  _createClass(Main, [{
    ...
    value: function shoot(basketball) {
      ...
      var x = _this.pointerEnd.x - _this.pointerStart.x;
      var y = _this.pointerEnd.y - _this.pointerStart.y;
      var duration = Math.round(pointer.duration);
      var length = Math.round(new Phaser.Line(_this.pointerStart.x, _this.pointerStart.y, _this.pointerEnd.x, _this.pointerEnd.y).length);
